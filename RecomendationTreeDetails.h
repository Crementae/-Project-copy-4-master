...
@class PlaceData;
@interface RecomendationTreeDetails :  UIViewController <UIScrollViewDelegate>{
    PlaceData *data;
...
@property PlaceData *data1;
@property PlaceData *data2;
@property PlaceData *data3;
