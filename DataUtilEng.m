...
//  ไม้ในไร่Project
//
//  Created by Crementae on 9/21/15.
//  Copyright © 2015 Adisorn Chatnartanakun. All rights reserved.
//
...
- (NSArray*)getEngData{
    ...
    NSString *path =@"http://rmfl.nagasoftware.com/api/plant_by_season.php?lang_code=2&season_id=0";
    if(path){
        ////NSLog(@"%@",path);
...
//Get Hot season data
- (NSArray*)getEngHotData{
    NSMutableArray *result = [[NSMutableArray alloc] init];
    
    NSString *path =@"http://rmfl.nagasoftware.com/api/plant_by_season.php?lang_code=2&season_id=1";
    if(path){
        // //NSLog(@"%@",path);
        NSURL *json = [NSURL URLWithString:path]; // jsonString
        //  //NSLog(@"URL is %@",[json absoluteString]);
...
//Get RainyData
- (NSArray*)getEngRainyData{
    NSMutableArray *result = [[NSMutableArray alloc] init];
    
    NSString *path =@"http://rmfl.nagasoftware.com/api/plant_by_season.php?lang_code=2&season_id=2";
    if(path){
        // //NSLog(@"%@",path);
        NSURL *json = [NSURL URLWithString:path]; // jsonString
        //  //NSLog(@"URL is %@",[json absoluteString]);
...
- (NSArray*)getEngColdData{
    NSMutableArray *result = [[NSMutableArray alloc] init];
    
    NSString *path =@"http://rmfl.nagasoftware.com/api/plant_by_season.php?lang_code=2&season_id=3";
    if(path){
        // //NSLog(@"%@",path);
        NSURL *json = [NSURL URLWithString:path]; // jsonString
        //  //NSLog(@"URL is %@",[json absoluteString]);
...
- (NSArray*)getEngRecomendationData{
    NSMutableArray *result = [[NSMutableArray alloc] init];
    
    NSString *path =@"http://rmfl.nagasoftware.com/api/plant_by_recommendation.php?lang_code=2";
    if(path){
        // //NSLog(@"%@",path);
        NSURL *json = [NSURL URLWithString:path]; // jsonString
        //  //NSLog(@"URL is %@",[json absoluteString]);
