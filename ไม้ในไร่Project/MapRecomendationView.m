...
#import "MapRecomendationFilterController.h"
...
@interface MapRecomendationView ()<CLLocationManagerDelegate, GMSMapViewDelegate>
...
@implementation MapRecomendationView{
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem * newBackButton = [[UIBarButtonItem alloc] initWithTitle:(@"Back") style:UIBarButtonItemStyleBordered target:self action:@selector(RecomendationTree:)];
...
-(void)RecomendationTree:(UIBarButtonItem *) sender{
...
-(void)AllMap:(id)sender{
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"
                                                 bundle:nil];
    MapViewController *allView= (MapViewController *)[sb instantiateViewControllerWithIdentifier:@"Map"];
   allView.data = data;
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    for(PlaceData *data in tableData){
        NSString *markerPath = [NSString stringWithFormat:@"PinRecommend.png"];
...
-(IBAction)searchBarItemAction:(id)sender{
    ...
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    ViewController *viewController = (MapRecomendationFilterController *)[sb instantiateViewControllerWithIdentifier:@"MapFilterRecomendation"];
...
-(void)mapView:(GMSMapView *)mapView didTapInfoWindowOfMarker:(GMSMarker *)marker{
    ...
    RecomendationTreeDetails *detailView = [[RecomendationTreeDetails alloc] init];
    
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    
    
    detailView = (RecomendationTreeDetails *)[sb instantiateViewControllerWithIdentifier:@"RecomendationView"];
