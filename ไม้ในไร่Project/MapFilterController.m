...
@interface MapFilterController ()

@end

@implementation MapFilterController{
    NSArray *tableData;
...
-(IBAction)searchBarItemAction:(id)sender{
    ...
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    ViewController *viewController = (MapViewController *)[sb instantiateViewControllerWithIdentifier:@"Map"];
