...
#import "MapSummerFilterController.h"
...
@interface MapSummerView()<CLLocationManagerDelegate, GMSMapViewDelegate>
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem * newBackButton = [[UIBarButtonItem alloc] initWithTitle:(@"Back") style:UIBarButtonItemStyleBordered target:self action:@selector(summer:)];
...
-(void)summer:(UIBarButtonItem *) sender{
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"
                                                 bundle:nil];
    SummerViewController *summerView= (SummerViewController *)[sb instantiateViewControllerWithIdentifier:@"SummerList"];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    for(PlaceData *data in tableData){
        NSString *markerPath = [NSString stringWithFormat:@"PinSummer.png"];
...
-(IBAction)searchBarItemAction:(id)sender{
    ...
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    ViewController *viewController = (MapSummerFilterController *)[sb instantiateViewControllerWithIdentifier:@"MapFilterSummer"];
...
-(void)mapView:(GMSMapView *)mapView didTapInfoWindowOfMarker:(GMSMarker *)marker{
    ...
    SummerTreeDetails *detailView = [[SummerTreeDetails alloc] init];
    
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    
    
    detailView = (SummerTreeDetails *)[sb instantiateViewControllerWithIdentifier:@"SummerView"];
