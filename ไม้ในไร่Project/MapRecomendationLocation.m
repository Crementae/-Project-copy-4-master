...
@interface MapRecomendationLocation ()

@end

@implementation MapRecomendationLocation{
...
- (void)viewDidLoad {
    ...
    //self.navigationController.navigationBar.tintColor = [[UIColor alloc]initWithRed:191.0/255.0 green:30.0/255.0 blue:46.0/255.0 alpha:1];
...
-(void)mapView:(GMSMapView *)mapView didTapInfoWindowOfMarker:(GMSMarker *)marker{
    ...
    RecomendationTreeDetails *view = (RecomendationTreeDetails *)[sb instantiateViewControllerWithIdentifier:@"RecomendationView"];
    view.data = data;
