...
- (void)viewDidLoad {
    ...
    _imageView2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"1.png"]];;
    _imageView3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"1.png"]];
    _imageView4 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"1.png"]];
    _imageView5 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"1.png"]];
...
-(void)actionHandleTapOnImageView:(UITapGestureRecognizer *)sender{
    ...
    AllSeasonGallery *view = (AllSeasonGallery *)[sb instantiateViewControllerWithIdentifier:@"AllSeasonGalleryViewI4"];
    view.data = data;
    ...
    view.index = (imageView.tag - 1);
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        AllSeasonGallery *view = (AllSeasonGallery *)[sb instantiateViewControllerWithIdentifier:@"AllSeasonGalleryViewI5"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        AllSeasonGallery *view = (AllSeasonGallery *)[sb instantiateViewControllerWithIdentifier:@"AllSeasonGalleryViewI6"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
