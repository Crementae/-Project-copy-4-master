...
@interface MapSummerLocation ()

@end

@implementation MapSummerLocation{
...
-(void)mapView:(GMSMapView *)mapView didTapInfoWindowOfMarker:(GMSMarker *)marker{
    ...
    SummerTreeDetails *view = (SummerTreeDetails *)[sb instantiateViewControllerWithIdentifier:@"SummerView"];
    view.data = data;
