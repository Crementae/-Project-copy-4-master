...
#import "MapColdLocation.h"
#import "PlaceData.h"
#import "ColdGallery.h"
...
@implementation ColdTreeDetails{
...
- (void)loadImage:(UIImageView*)baseImage with:(NSString *)imageUrl ofNumber:(int) galleryNumber ifNilLoadPath:(NSString*)defaultPath{
    
    
    
    
    if(![appPrefs enableOnlineMode]){
        return;
    }else{
        Reachability *reachability = [Reachability reachabilityForInternetConnection];
        ...
        if (status == ReachableViaWWAN && ![appPrefs enable3g])
        {
            return;
        }
    }
...
-(void)actionHandleTapOnImageView:(UITapGestureRecognizer *)sender{
    ...
    if((int)[[UIScreen mainScreen]bounds].size.height==480){
        ...
        ColdGallery *view = (ColdGallery *)[sb instantiateViewControllerWithIdentifier:@"ColdGalleryViewI4"];
        view.data = data;
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        ColdGallery *view = (ColdGallery *)[sb instantiateViewControllerWithIdentifier:@"ColdGalleryViewI5"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        ColdGallery *view = (ColdGallery *)[sb instantiateViewControllerWithIdentifier:@"ColdGalleryViewI6"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
...
- (IBAction)locationClick:(id)sender {
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"
                                                 bundle:nil];
    MapColdLocation *mapView = (MapColdLocation *)[sb instantiateViewControllerWithIdentifier:@"MapColdLocation"];
    mapView.data = data;
