...
#import "MapSummerLocation.h"
#import "PlaceData.h"
#import "SummerGallery.h"
...
-(void)actionHandleTapOnImageView:(UITapGestureRecognizer *)sender{
    ...
    if((int)[[UIScreen mainScreen]bounds].size.height==480){
        ...
        SummerGallery *view = (SummerGallery *)[sb instantiateViewControllerWithIdentifier:@"SummerGalleryViewI4"];
        view.data = data;
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        SummerGallery *view = (SummerGallery *)[sb instantiateViewControllerWithIdentifier:@"SummerGalleryViewI5"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        SummerGallery *view = (SummerGallery *)[sb instantiateViewControllerWithIdentifier:@"SummerGalleryViewI6"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
...
- (IBAction)locationClick:(id)sender {
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"
                                                 bundle:nil];
    MapSummerLocation *mapView = (MapSummerLocation *)[sb instantiateViewControllerWithIdentifier:@"MapSummerLocation"];
    mapView.data = data;
