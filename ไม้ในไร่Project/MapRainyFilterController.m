...
@interface MapRainyFilterController ()

@end

@implementation MapRainyFilterController{
    NSArray *tableData;
...
-(IBAction)searchBarItemAction:(id)sender{
    ...
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    ViewController *viewController = (MapRainyView *)[sb instantiateViewControllerWithIdentifier:@"MapRainy"];
