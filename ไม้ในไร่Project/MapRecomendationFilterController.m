//
//  MapRecomendationFilterController.m
//  ไม้ในไร่Project
//
...
@interface MapRecomendationFilterController ()

@end

@implementation MapRecomendationFilterController{
    NSArray *tableData;
...
-(IBAction)searchBarItemAction:(id)sender{
    ...
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    ViewController *viewController = (MapRecomendationView *)[sb instantiateViewControllerWithIdentifier:@"MapRecomendation"];
