...
#import "MapRainyFilterController.h"
...
@interface MapRainyView ()<CLLocationManagerDelegate, GMSMapViewDelegate>
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem * newBackButton = [[UIBarButtonItem alloc] initWithTitle:(@"Back") style:UIBarButtonItemStyleBordered target:self action:@selector(RainyTree:)];
...
-(void)RainyTree:(UIBarButtonItem *) sender{
...
-(void)AllMap:(id)sender{
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"
                                                 bundle:nil];
    MapRainyView *allView= (MapRainyView *)[sb instantiateViewControllerWithIdentifier:@"Map"];
    allView.data = data;
...
-(IBAction)searchBarItemAction:(id)sender{
    ...
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    ViewController *viewController = (MapRainyFilterController *)[sb instantiateViewControllerWithIdentifier:@"MapFilterRainy"];
...
-(void)mapView:(GMSMapView *)mapView didTapInfoWindowOfMarker:(GMSMarker *)marker{
    ...
    RainyTreeDetails *detailView = [[RainyTreeDetails alloc] init];
    
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    
    
    detailView = (RainyTreeDetails *)[sb instantiateViewControllerWithIdentifier:@"RainyView"];
