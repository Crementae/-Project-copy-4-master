...
@interface MapSummerFilterController ()

@end

@implementation MapSummerFilterController{
    NSArray *tableData;
...
-(IBAction)searchBarItemAction:(id)sender{
    ...
    UIStoryboard*  sb = [UIStoryboard storyboardWithName:@"Main"
                                                  bundle:nil];
    ViewController *viewController = (MapSummerView *)[sb instantiateViewControllerWithIdentifier:@"MapSummer"];
