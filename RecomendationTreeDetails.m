...
#import "MapRecomendationLocation.h"
#import "PlaceData.h"
...
@interface RecomendationTreeDetails ()
...
@implementation RecomendationTreeDetails{
...
-(void)actionHandleTapOnImageView:(UITapGestureRecognizer *)sender{
    ...
    if((int)[[UIScreen mainScreen]bounds].size.height==480){
        ...
        RecomendationGallery *view = (RecomendationGallery *)[sb instantiateViewControllerWithIdentifier:@"RecomendationGalleryViewI4"];
        view.data = data;
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        RecomendationGallery *view = (RecomendationGallery *)[sb instantiateViewControllerWithIdentifier:@"RecomendationGalleryViewI5"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
        ...
        UIImageView *imageView = (UIImageView *)sender.view;
        UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"                                                 bundle:nil];
        RecomendationGallery *view = (RecomendationGallery *)[sb instantiateViewControllerWithIdentifier:@"RecomendationGalleryViewI6"];
        view.data = data;
        view.imageView1 = _imageView1.image;
        view.imageView2 = _imageView2.image;
        view.imageView3 = _imageView3.image;
...
- (IBAction)locationClick:(id)sender {
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"Main"
                                                 bundle:nil];
    MapRecomendationLocation *mapView = (MapRecomendationLocation *)[sb instantiateViewControllerWithIdentifier:@"MapRecomendationLocation"];
    mapView.data = data;
